...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  # read
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                # rsp == 1?
  400f0e:	74 20                	je     400f30 <phase_2+0x34>      # if rsp == 1: goto f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>      # else failed
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>      # goto f30

  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax            # 
  400f1a:	01 c0                	add    %eax,%eax                  # eax += eax
  400f1c:	39 03                	cmp    %eax,(%rbx)                # eax == *rbx ?
  400f1e:	74 05                	je     400f25 <phase_2+0x29>      # if eax == *rbx goto f25
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>      # else fail!

  400f25:	48 83 c3 04          	add    $0x4,%rbx                  # rbx += 4
  400f29:	48 39 eb             	cmp    %rbp,%rbx                  # cmp the address
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>      # if rbp != rbx, goto f17
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>      # goto f3c success.

  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx             # rbx = &*(rsp + 4)  &x0
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp            # rbp = &*(rsp + 24) &x5
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>      # goto f17

  400f3c:	48 83 c4 28          	add    $0x28,%rsp                 # exit
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi                 # sscanf("%d %d", rdx, rcx)
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax                      # if eax > 1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>          # if eax > 1, goto 6a
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>          # else fail.

  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                 # rdx > 7 ？
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>          # IF rdx > 7, goto: fad failed!
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                 # eax = rdx
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)             # goto *0x402470 + 8 * rax (rdx)  

  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                     # eax = 207
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>          # goto fbe
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                 # x1 == eax
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>          # if x1 == eax goto fc9, success!
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp          # edi = x0, esi = 0, edx = 14
  ...
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # if ecx <= edi goto: ff2
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    # edx = (-1 + rcx)
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax          # eax *= 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39> # rtn

  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax          # 
  400ff7:	39 f9                	cmp    %edi,%ecx
  400ff9:	7d 0c                	jge    401007 <func4+0x39>  # if ecx >= edi, goto end. rtn 0!
...
000000000040100c <phase_4>:
  ...
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>   # sscanf("%d %d", rdx, rcx)
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>

  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e>          # if x0 <= 14 , goto 3a
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>

  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                      # edx = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                      # esi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                 # edi = x0
  401048:	e8 81 ff ff ff       	callq  400fce <func4>                 # func4
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>          # if eax != 0, goto 58, fail.
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                 # 
  401056:	74 05                	je     40105d <phase_4+0x51>          # if rcx == 0, success
...
0000000000401062 <phase_5>:
  ...
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                # used for stack protection
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax                     
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>       # get str length
  40107f:	83 f8 06             	cmp    $0x6,%eax                    # 
  401082:	74 4e                	je     4010d2 <phase_5+0x70>        # if len == 6, goto d2
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>        # if len != 6, boom!
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>

  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx           # ecx = *(rbx + rax)  get a char in the string
  40108f:	88 0c 24             	mov    %cl,(%rsp)                   # *rsp = ecx_low_1 byte
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                  # rdx = exc_low
  401096:	83 e2 0f             	and    $0xf,%edx                    # edx &= 0xf

  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx          # edx = *(0x4024b0 + rdx)
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)        # *(10 + rsp + rax) = edx_low_1byte

  4010a4:	48 83 c0 01          	add    $0x1,%rax                    # rax += 1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                    # 
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>        # if rax != 6, goto 8b

  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)              # 
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi               # esi = $0x40245e
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi              # rdi = 10 + rsp
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>   # check if rdi != rsi "flyers"
  4010c2:	85 c0                	test   %eax,%eax                    # 
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>        # if rdi == rsi, goto d9
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>        # else fail.
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>

  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                    # eax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>        # goto: 8b
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax              # end.
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>  # read 6 numbers store on the stack
  40110b:	49 89 e6             	mov    %rsp,%r14                  # r14 = rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                 # r12 = 0

  401114:	4c 89 ed             	mov    %r13,%rbp                  # rbp = r13 = rsp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax             # eax = x[i]
  40111b:	83 e8 01             	sub    $0x1,%eax                  # eax -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax                  #
  401121:	76 05                	jbe    401128 <phase_6+0x34>      # if eax <= 5, goto: 128
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>      # if eax > 5, fail!

  401128:	41 83 c4 01          	add    $0x1,%r12d                 # r12d += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                 # 
  401130:	74 21                	je     401153 <phase_6+0x5f>      # if r12d != 6, goto: 153
  ...
  40113e:	75 05                	jne    401145 <phase_6+0x51>      # if 
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>      # eax == *rbp, failed!
  401145:	83 c3 01             	add    $0x1,%ebx                  # ebx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                  # 
  40114b:	7e e8                	jle    401135 <phase_6+0x41>      # if ebx <= 5, goto 135
  40114d:	49 83 c5 04          	add    $0x4,%r13                  # r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>      # goto 114

  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi            # rsi = x[6] -- end
  401158:	4c 89 f0             	mov    %r14,%rax                  # rax = r14
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                  # ecx = 7

  401160:	89 ca                	mov    %ecx,%edx                  # edx = ecx
  401162:	2b 10                	sub    (%rax),%edx                # edx -= *rax
  401164:	89 10                	mov    %edx,(%rax)                # *rax = edx  ---x[i] = 7 - x[i] 
  401166:	48 83 c0 04          	add    $0x4,%rax                  # rax += 4
  40116a:	48 39 f0             	cmp    %rsi,%rax                  # 
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>      # if rsi != rax, goto: 160
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                  # esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>      # goto 197

  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx             # rdx = *(rdx + 8)
  40117a:	83 c0 01             	add    $0x1,%eax                  # eax += 1
  40117d:	39 c8                	cmp    %ecx,%eax                  #
  40117f:	75 f5                	jne    401176 <phase_6+0x82>      # if ecx != eax goto 176
  401181:	eb 05                	jmp    401188 <phase_6+0x94>      # goto 188

  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx             # edx = 0x6032d0

  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)     # y[rsi*2] = rdx  y starts at rsp + 32 address copy?
  40118d:	48 83 c6 04          	add    $0x4,%rsi                  # rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                 # 
  401195:	74 14                	je     4011ab <phase_6+0xb7>      # if rsi == 24, goto 1ab

  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx         # ecx = rsp + rsi = x[rsi]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                  #
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>      # if ecx < 1, goto: 183
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                  # else eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx             # edx = ..
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>      # goto 176

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx            # rbx = y[i]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax            # rax = &y[i + 1]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi            # rsi = &y[6] -- end of the array
  ...
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>      # if rsi == end, goto 1d2
  4011cd:	48 89 d1             	mov    %rdx,%rcx                  # else rcx = rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>      # goto 1bd
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>      # if rbx >= eax, goto 1ee
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>

  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx             # rbx = *(rbx + 8)
  4011f2:	83 ed 01             	sub    $0x1,%ebp                  # ebp -= 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>      # if ebp != 0, goto 1df

  4011f7:	48 83 c4 50          	add    $0x50,%rsp                 # else, end???
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
...
0000000000401338 <strings_not_equal>:
  ...
  401357:	41 39 c4             	cmp    %eax,%r12d                       // len1 != len2
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>  // return 1

  40135c:	0f b6 03             	movzbl (%rbx),%eax
  40135f:	84 c0                	test   %al,%al                          // *s1 == 0x0
  401361:	74 25                	je     401388 <strings_not_equal+0x50>  // return 0

  401363:	3a 45 00             	cmp    0x0(%rbp),%al                    // *s2 == *s1 != 0x0
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>  // if (*s2 == *s1), to 72

  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>  // if (*s2 != *s1) return 1

  40136a:	3a 45 00             	cmp    0x0(%rbp),%al                    // cmp *s1 == *s2
  40136d:	0f 1f 00             	nopl   (%rax)                           // 
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>  // if *s1 != *s2 return 1;

  401372:	48 83 c3 01          	add    $0x1,%rbx                        // s1++
  401376:	48 83 c5 01          	add    $0x1,%rbp                        // s2++
  40137a:	0f b6 03             	movzbl (%rbx),%eax                      // eax = *s1
  40137d:	84 c0                	test   %al,%al                          // *s1 == 0x0 ?
  40137f:	75 e9                	jne    40136a <strings_not_equal+0x32>  // if s1 != 0x0, to 6a
  401381:	ba 00 00 00 00       	mov    $0x0,%edx                        // else edx = 0
  401386:	eb 13                	jmp    40139b <strings_not_equal+0x63>  // return 0;
...
000000000040145c <read_six_numbers>:
  ...
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                 # rcx has the address of rsi + 4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                # rax has the address of rsi + 20
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                 # rsp + 8 have rsi + 20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                # rax has the address of rsi + 16
  401474:	48 89 04 24          	mov    %rax,(%rsp)                    # rsp have rsi + 16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9                  # r9 has the address of rsi + 12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8                  # r8 has the address of rsi + 8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi                 # esi was assigned
  401485:	b8 00 00 00 00       	mov    $0x0,%eax                      # eax = 0
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>   # scanf
  40148f:	83 f8 05             	cmp    $0x5,%eax                      # eax > 5 ?
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d> # if eax > 5, goto 99
  401494:	e8 a1 ff ff ff       	callq  40143a <explode_bomb>          # else boom
